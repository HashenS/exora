...
const Pricing = () => {
  ...
  const dronePlans = [
    { name: 'Starter Reel', price: '7,500', features: ['1-Min Edited Clip', 'AI Voiceover Included', '1.5 Hours Fly Time', 'Standard Color Correction'] },
  ...
  return (
    <section id="pricing" className="min-vh-100 d-flex align-items-center py-5 position-relative">
